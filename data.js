...
<script async src="https://www.threads.com/embed.js"></script>`
  ...
  /* ------------------------------------------------------------------------
     ...
     ---------------------------------------------------------------------- */
  leaderboard: {
    updatedAt: { id: "Rabu, 24 September 2026 · 09:05 WIB", en: "Wednesday, 24 September 2026 · 09:05 AM WIB" },
    data: [
      { name: "Aryo Seto",          km: 42.2, runs: 6, longest: 15.0, pace: "5:50", elev: 80  },
      ...
      { name: "Sultan Ucok",        km: 20.5, runs: 3, longest: 7.4,  pace: "6:34", elev: 3   },
