...
const SITE = {
  ...
  /* ------------------------------------------------------------------------
     ...
     ---------------------------------------------------------------------- */
  statsBar: [
    { id: "Tangerang",              en: "Tangerang"              },
    { id: "Lari Tiap Minggu",       en: "Every Week"             },
    { id: "Siapa Aja Boleh Gabung", en: "Anyone Can Join"        },
    { id: "Sejak Feb 2025",         en: "Since Feb 2025"         },
    { id: "990 Followers IG",       en: "990 IG Followers"       },
  ],
...
<script async src="https://www.threads.com/embed.js"></script>`
  ...
  /* ------------------------------------------------------------------------
     ...
     ---------------------------------------------------------------------- */
  leaderboard: {
    updatedAt: { id: "Jumat, 25 September 2026 · 18:47 WIB", en: "Friday, 25 September 2026 · 06:47 PM WIB" },
    data: [
      { name: "Aryo Seto",          km: 73.2, runs: 7, longest: 31.0, pace: "5:20", elev: 109 },
      { name: "Raden Mas Goblin",   km: 28.8, runs: 5, longest: 10.4, pace: "5:32", elev: 19  },
      { name: "Sultan Ucok",        km: 27.5, runs: 4, longest: 7.4,  pace: "6:43", elev: 26  },
      { name: "Achmad Hafidz",      km: 27.5, runs: 2, longest: 20.0, pace: "5:36", elev: 217 },
      { name: "Kevin Octo Pratama", km: 24.2, runs: 3, longest: 9.1,  pace: "6:43", elev: 140 },
      { name: "Tiahayu Aulia",      km: 21.6, runs: 3, longest: 10.1, pace: "6:53", elev: 7   },
      { name: "Ismet Djailani",     km: 21.0, runs: 3, longest: 15.0, pace: "7:42", elev: 31  },
      { name: "Azhar Wijaya",       km: 20.2, runs: 3, longest: 8.2,  pace: "6:37", elev: 22  },
      { name: "Nicko Ferdinand",    km: 20.1, runs: 2, longest: 10.1, pace: "6:43", elev: 22  },
      { name: "Ikmal Maulana",      km: 18.0, runs: 4, longest: 5.9,  pace: "7:29", elev: 60  },
      { name: "Daniel Passarela",   km: 15.6, runs: 7, longest: 5.7,  pace: "5:50", elev: 6   },
      { name: "Agung Tranata",      km: 15.3, runs: 3, longest: 6.0,  pace: "7:37", elev: 13  },
      { name: "Silvia A.",          km: 13.2, runs: 3, longest: 7.0,  pace: "7:49", elev: 23  },
      { name: "Dini Safitri",       km: 13.0, runs: 3, longest: 8.0,  pace: "7:19", elev: 11  },
      { name: "Awand Hadiningrat",  km: 12.8, runs: 3, longest: 6.0,  pace: "7:03", elev: 7   },
      { name: "Arief Suryana Putra",km: 12.8, runs: 4, longest: 5.1,  pace: "6:37", elev: 66  },
      { name: "Dicky Cipta Pradana",km: 12.0, runs: 2, longest: 6.0,  pace: "6:53", elev: 25  },
      ...
      { name: "Rizky Fahranjie",    km: 10.0, runs: 2, longest: 5.0,  pace: "7:55", elev: 6   },
    ]
  },
